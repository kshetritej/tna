...
"[project]/.next-internal/server/app/api/admin/admins/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/admins/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function DELETE(_req, { params }) {
    ...
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.delete({
        where: {
            id: parseInt(id)
        }
    });
...
async function PATCH(req, { params }) {
    ...
    const admin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.update({
        where: {
            id: parseInt(id)
        },
        data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ad81040._.js.map